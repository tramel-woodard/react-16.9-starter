...
Babel is a **JavaScript compiler** that allows ECMAScript 2015+ code to be rendered into a backwards compatible version of JavaScript that can be consumed by both modern and older browsers.
